...
directionalLight1.position.set(parameters.directionalLight1PosX,1,1)
const helper1 = new THREE.DirectionalLightHelper( directionalLight1, 1 );
directionalLight1.rotation.set(-Math.PI, 0, -Math.PI)
...
directionalLight2.position.set(1,parameters.directionalLight2PosY,1)
const helper2 = new THREE.DirectionalLightHelper( directionalLight2, 1 );
directionalLight2.rotation.set(-Math.PI, 0, -Math.PI)
